function [cost, grad, preds,outputs] = cnnCost(theta, images, labels,cnnConfig, meta, pred)
...
for l = 2 : numLayers
    ...
    switch tempLayer.type
        ...
        case {'sigmoid','tanh','relu','softmax','satlin','pca'}
...
for l = numLayers-1 : -1 : 2
    ...
    switch tempLayer.type
        ...
        case 'satlin'
            temp{l}.gradBefore = theta{l + 1}.W' * temp{l + 1}.gradBefore .* (temp{l}.after > 0 == temp{l}.after < 1);
            grad{l}.W = temp{l}.gradBefore * temp{l - 1}.after' / numImages;
            grad{l}.b = mean(temp{l}.gradBefore, 2);
        case 'tanh'
